...
public class MemberForm {
    ...
    private String dummy_address;
    private String dummy_address2;
	...
	public String getDummy_address() {
		return this.dummy_address;
	}

	public void setDummy_address(String dummy_address) {
		this.dummy_address = dummy_address;
	}

	public String getDummy_address2() {
		return this.dummy_address2;
	}

	public void setDummy_address2(String dummy_address2) {
		this.dummy_address2 = dummy_address2;
	}
